    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trade', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='Asset.trade')),
            ],
        ),
        migrations.CreateModel(
            name='ProduceInvoice',
            fields=[
                ...
                ('start_time', models.DateTimeField(blank=True, default=django.utils.timezone.now, null=True)),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('produce', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='Asset.produce')),
            ],
        ),
        migrations.CreateModel(
            name='FarmInvoice',
            fields=[
                ...
                ('slug', models.SlugField(blank=True, max_length=250, null=True)),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('farm', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='Asset.farm')),
                ('partner', models.ForeignKey(default=2, on_delete=django.db.models.deletion.PROTECT, to='Asset.partner')),
            ],
        ),
    ]
